...
/**
 * Main class for a Human vs Computer version of Battleship game. Creates a
 * single instance of Ocean. Gets user input(row and column) for interacting
 * with and playing against the computer.
 *
 */
...
public class BattleshipGame {
	...
	/**
	 * Each time call the function, start a new battleship game. This method accepts
	 * ”shots” from the user; display the results; print final scores; and ask the
	 * user if he/she wants to play again
	 * 
	 * @param scan
	 */
