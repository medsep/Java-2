...
/**
 * This abstract class describes the characteristics common to all ships. It
 * includes basic parameters of a ship and methods that manipulate the ships.
 * 
...
public abstract class Ship {
	...
	private int length;
	/**
	 * "horizontal" is a boolean that represents whether the ship is going to be
	 * placed horizontally or vertically.
	 */
	private boolean horizontal;
	/**
	 * "hit" is an array of 4 booleans that indicate whether that part of the ship
	 * has been hit or not.
	 */
	private boolean[] hit;
	...
	/**
	 * Showing whether the ship is sunk with string, return s for sunk and x for not
	 * sunk
	 */
