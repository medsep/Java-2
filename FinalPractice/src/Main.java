...
public class Main {
	...
	public static void main(String[] args) {
		...
		Map<String, Integer> ret = Main.wordCount(strings);
		...
		System.out.println("countUniqueWords: " + Main.countUniqueWords(countUniqueWordsArray));
		System.out.println();

		// caseINsensitive count
		System.out.println("countUniqueWords: " + Main.countUniqueWordsCaseInSensitive(countUniqueWordsArray));
		System.out.println();
		...
		Map<String, String> m = Main.setToppings(food);
		...
		friendShips.put("Dani", "John");

		TreeMap<String, TreeSet<String>> friendList = Main.friendList(friendShips);
		...
		TreeSet<Integer> treeSet = Main.unionSets(hashSet);
