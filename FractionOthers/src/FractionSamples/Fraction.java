...
public class Fraction implements Comparable {
	...
	/**
	 * Normalizes the fraction. Throws an exception if the denominator is zero.
	 * 
	...
	/**
	 * Generates a fraction from a given string. Throws an ArithmeticException if
	 * given a string representing a fraction whose denominator is zero. Throws an
	 * NumberFormatException if the string does not follow the following two
	 * formats: 1) a; 2) a/b (blanks are allowed).
	 * 
	 * @param fraction A String containing either a whole number, such as "5" or "
	 *                 -3", or a fraction, such as "8/ -12".
	 */
	...
	/**
	 * Computes the negate of this fraction; that is, a value that has the same
	 * numeric value of the original fraction, but the opposite sign.
	 * 
	...
	/**
	 * Returns true if o is a fraction equal to this fraction, and false in all
	 * other cases. Is used for assertEquals(expected, actual) JUnit tests.
	 */
	@Override
	 ...
	 * 
	 * @return A string of the form n/d (n is the numerator and d is the
	 *         denominator), or just n if d is 1.
	 */
	@Override
