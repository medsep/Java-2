...
public class HumanPlayer {
	...
	/**
	 * Asks the Human player whether to take another card and uses the given scanner
	 * to prompt for a response.
	 * 
	...
	/**
	 * Prints the sum of all of this Human's cards, and the sum of each of the other
	 * (computer) players' visible cards.
	 * 
	 * @param human   This human player
	 * @param player1 Another (computer) player
	 * @param player2 Another (computer) player
	...
	public void showCards(HumanPlayer human, ComputerPlayer player1, ComputerPlayer player2, ComputerPlayer player3) {
		...
		// Simply print out what each player has base on their visible cards/scores.
		System.out.println();
	...
	/**
	 * Puts the specified card in this human's hand as the hidden card. Prints a
	 * message saying that the card is being taken, and prints the value of the
	 * hidden card.
	 * 
	...
	public void takeHiddenCard(int card) {
		// Students: your code goes here.
		// Add new card to existing total.
		this.hiddenCard += card;
		System.out.println(this.name + " takes a hidden card is being taken. (It's a " + card + ".)");
	}
	...
	public void takeVisibleCard(int card) {
		...
		System.out.println(name + " has taken a card. It's a " + card + ".");
	}
	...
	/**
	 * Return this player's total score (the total of all this human player's
	 * cards). That is to say, the sum of the visible cards + the hidden card.
	 * 
	 * @return total score
	 */
	public int getScore() {
