...
/**
 * In this assignment, you will build an information parser. The program will
 * read and parse text from a file, process and extract the information needed,
 * request new information from the user, and then write all of the information
 * to a new file.
 * 
 * The Main class will drive the entire program, and the â€œmainâ€� method calls
 * have been provided for you. Nothing needs to be completed in the main method.
 */
public class Main {
