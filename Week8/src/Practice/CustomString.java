...
public class CustomString {
	...
	public String remove(String arg) {
		// TODO Implement method
		if (this.myString == null || this.myString.isEmpty() || !this.isSet) {
			return "";
		}
		arg = arg.toUpperCase() + arg.toLowerCase();
		String result = "";
	...
	public String reverse(String arg) {
		...
		for (int i = 0; i < chars.length; i++) {
			char ch = chars[i];
			if (arg.indexOf(ch) != -1 && Character.isUpperCase(ch)) {
				chars[i] = Character.toLowerCase(ch);
			}
			if (arg.indexOf(ch) != -1 && Character.isLowerCase(ch)) {
